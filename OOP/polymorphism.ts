...
// Another example of polymorphism using interfaces
class Shape {
    getArea(){
        return 0;
    }
...
getArea(circle); // Output: Area of circle with radius 5
getArea(rectangle); // Output: Area of rectangle with length 4 and width 6