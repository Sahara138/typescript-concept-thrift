...
// private ba protected er maddhome encapsulated korte pari

class BankAccountForEmployee {
    public readonly userId: number;
    public  username: string;
    // private  balance: number; //encapsulated
...
class StudentsBankAccount extends BankAccount {
    constructor(userId: number, username: string, balance: number) {
...
const studentsAccount = new StudentsBankAccount(2, "Student Bhai", 500);
