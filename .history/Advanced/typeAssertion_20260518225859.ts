...
// when we can define Better Type  or type narrowing then we can be use type assertion but if we can not define better type then we can be use type assertion.